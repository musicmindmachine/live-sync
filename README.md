...
- Add a non-LOM plugin bridge if you need guaranteed VST or Max device instantiation across nested chains or across Live setups where the internal browser runtime is unavailable.
